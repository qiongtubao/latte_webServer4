 	...
 	function(require, exports, module, window) {
 		var Cluster = require("cluster")
			...
			var Server = function(config) {
				...
				if(this.config.rpc && this.config.rpc.rpcPath && !latte_lib.isArray(this.config.rpc.rpcPath)) {
	 		...
	 		(function() {
	 			...
	 			this.watchWebAndRpc = function() {
	 				...
	 				if(this.config.rpc && this.config.rpc.rpcPath && this.config.rpc.rpcPath.length > 0 ) {
	 				...
	 				this.webReload = function() {
	 					this.config.restart = 1;
 						this.rpc.CallAll("webReload",[], function() {
